...
| maxConcurrentReconciles | int | `1` | # Sets the number of simultaneous reconciles per Kind. When set to 1 only one dashboard will be reconciled at a time, but a single datasource can be reconciled in parallel. |
