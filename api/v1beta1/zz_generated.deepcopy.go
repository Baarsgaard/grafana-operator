...
func (in *GrafanaContactPointSpec) DeepCopyInto(out *GrafanaContactPointSpec) {
	*out = *in
	out.GrafanaUIDSpec = in.GrafanaUIDSpec
	in.GrafanaCommonSpec.DeepCopyInto(&out.GrafanaCommonSpec)
	if in.Settings != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GrafanaUIDSpec) DeepCopyInto(out *GrafanaUIDSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GrafanaUIDSpec.
func (in *GrafanaUIDSpec) DeepCopy() *GrafanaUIDSpec {
	if in == nil {
		return nil
	}
	out := new(GrafanaUIDSpec)
	in.DeepCopyInto(out)
	return out
}
